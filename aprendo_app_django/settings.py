"""
Django settings for aprendo_app_django project.
...
ALLOWED_HOSTS = ['*']  # En producción idealmente pondrás el dominio de render, ej: ['aprendo-backend.onrender.com']
...
ROOT_URLCONF = 'aprendo_app_django.urls'
...
WSGI_APPLICATION = 'aprendo_app_django.wsgi.application'
